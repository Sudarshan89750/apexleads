...
import { FileText, ListChecks, ArrowUpCircle, PartyPopper, PlusCircle } from 'lucide-react';
...
const BaseNode: React.FC<NodeProps<FunnelStep>> = ({ data }) => {
  return (
...
export const PlaceholderNode: React.FC<NodeProps> = () => {
  return (
    <>
      <div className="w-64 h-24 flex items-center justify-center border-2 border-dashed rounded-lg bg-muted/50 hover:bg-muted/80 transition-colors cursor-pointer">
